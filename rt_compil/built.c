...
double evaluateLevelSet(float3 position, float level_set[20][20][20]);
int outOfRange(float3 pos);
void    boule_level_set(float level_set[20][20][20]);
int 	DDA (float3 pos, float3 dir, float level_set[20][20][20]);
...
void    plan_level_set(float level_set[20][20][20]) {
